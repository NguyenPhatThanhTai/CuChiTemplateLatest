...
<?php $__env->startSection('content'); ?>
  <div class="booking-page">
    ...
    <?php $__currentLoopData = $booking_sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php switch($item['_type']):
        case ('text_only'): ?>
          <?php echo $__env->make('partials.booking.detail-text-only', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php break; ?>

        <?php case ('row'): ?>
          <?php echo $__env->make('partials.booking.detail-row', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php break; ?>

        <?php case ('mix'): ?>
          <?php echo $__env->make('partials.booking.detail-mix', ['item' => $item], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          <?php break; ?>
      <?php endswitch; ?>
    ...
    <?php if(!empty($available_rooms)): ?>
      ...
      <?php $__currentLoopData = $available_rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        ?>
        <?php if(in_array($room['room_type'], [1, 2, 3])): ?>
            <div class="scroll-to-here"></div> 
          <?php echo $__env->make('partials.booking.detail-row', ['item' => $item, 'search_data' => $search_data], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php elseif($room['room_type'] == 4): ?>
            <div class="scroll-to-here"></div> 
          <?php echo $__env->make('partials.booking.detail-mix', ['item' => $item, 'search_data' => $search_data], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
  </div>

  <?php echo $__env->make('sections.our-insights', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="booking-popup">
    <div class="popup-content">
      ...
      <form action="<?php echo e(admin_url('admin-post.php')); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol14_3/infinityfree.com/if0_39073049/htdocs/wp-content/themes/cuchi-theme/resources/views/booking.blade.php ENDPATH**/ ?>